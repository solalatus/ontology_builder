...
Last updated: 2026-08-21T15:00:26.890Z
...
```
{
  "yaml": "competency_questions:\n  - text: What maintenance state does this asset currently have?\n  - text: Which assets are currently operating, degraded, or failed?\n  - text: What failure event caused this asset to enter a failed state?\n  - text: Which failed assets or failed states came from that failure event?\n  - text: What maintenance process does this work order cover?\n  - text: What maintenance strategy governs this maintenance process?\n  - text: Which maintenance activities are included in this maintenance process?\n  - text: What qualification is required for this maintenance activity?\n  - text: Which qualified maintenance person can perform this maintenance activity?\n  - text: What required function is associated with this failure event?\n  - text: What required function is associated with the process the asset is carrying out when it’s functioning?\n  - text: What failure mode code describes this known failure pattern or undesirable condition?\n  - text: What failure effects resulted from this failure event?"
}
```
...
```
{
  "yaml": "actions:\n  classifyItemAsFailed:\n    input: Item\n    preconditions: []\n    effect: Record that the item is in a failed state.\n    verification: Confirm the item now shows a failed state.\n  createMaintenanceWorkOrderForMaintenanceProcess:\n    input: MaintenanceProcess\n    preconditions: []\n    effect: Create a maintenance work order for the maintenance process.\n    verification: Confirm a maintenance work order exists for the maintenance process.\n  assignQualifiedMaintenancePersonToMaintenanceActivity:\n    input: MaintenanceActivity\n    preconditions: []\n    effect: Assign a qualified maintenance person to the maintenance activity.\n    verification: Confirm the maintenance activity shows the assigned maintenance person.\n  startMaintenanceProcess:\n    input: MaintenanceProcess\n    preconditions: []\n    effect: Record that the maintenance process has started.\n    verification: Confirm the maintenance process shows that it has started.\n  closeMaintenanceWorkOrder:\n    input: MaintenanceWorkOrder\n    preconditions: []\n    effect: Record that the maintenance work order is closed.\n    verification: Confirm the maintenance work order shows a closed state."
}
```
...
CONSISTENCY CHECK — 5 new problem(s) from this edit:
  [error] action-input-missing — Action "assignQualifiedMaintenancePersonToMaintenanceActivity" has no input class. Give it the one class the action is fundamentally about.
  ...
  [error] action-input-missing — Action "createMaintenanceWorkOrderForMaintenanceProcess" has no input class. Give it the one class the action is fundamentally about.
...
#   [error] action-input-missing — Action "assignQualifiedMaintenancePersonToMaintenanceActivity" has no input class.
...
#   [error] action-input-missing — Action "createMaintenanceWorkOrderForMaintenanceProcess" has no input class.
...
```
{
  "yaml": "classes:\n  MaintainableItem: {}\n  MaintenanceState: {}\n  FailureEvent: {}\n  FailedState: {}\nactions:\n  classifyItemAsFailed:\n    input: MaintainableItem\n    effect: Record that the maintainable item is in a failed state.\n    verification: Confirm the maintainable item now shows a failed state."
}
```
...
#   [error] action-input-missing — Action "createMaintenanceWorkOrderForMaintenanceProcess" has no input class.
#   [error] action-input-missing — Action "startMaintenanceProcess" has no input class.
#   [warning] unreachable-from-action-input — Action "classifyItemAsFailed" has input class MaintainableItem, and its effect refers to FailedState, which is not connected to it at all.
...
```
{
  "yaml": "classes:\n  MaintenanceWorkOrderRecord: {}\n  MaintenanceProcess: {}\n  MaintenanceStrategy: {}\n  MaintenanceActivity: {}\n  QualifiedMaintenancePerson: {}\n  QualificationSpecification: {}\nactions:\n  createMaintenanceWorkOrderForMaintenanceProcess:\n    input: MaintenanceProcess\n    effect: Create a maintenance work order record for the maintenance process.\n    verification: Confirm a maintenance work order record exists for the maintenance process.\n  assignQualifiedMaintenancePersonToMaintenanceActivity:\n    input: MaintenanceActivity\n    effect: Assign a qualified maintenance person to the maintenance activity.\n    verification: Confirm the maintenance activity shows the assigned qualified maintenance person.\n  startMaintenanceProcess:\n    input: MaintenanceProcess\n    effect: Record that the maintenance process has started.\n    verification: Confirm the maintenance process shows that it has started.\n  closeMaintenanceWorkOrder:\n    input: MaintenanceWorkOrderRecord\n    effect: Record that the maintenance work order record is closed.\n    verification: Confirm the maintenance work order record shows a closed state."
}
```

### Turn 8 — tool

Applied. Added 6, updated 4 existing item(s).

CONSISTENCY CHECK — 2 new problem(s) from this edit:
  [warning] unreachable-from-action-input — Action "assignQualifiedMaintenancePersonToMaintenanceActivity" has input class MaintenanceActivity, and its effect refers to QualifiedMaintenancePerson, which is not connected to it at all. Add or redirect a relationship so the agent can navigate from MaintenanceActivity to QualifiedMaintenancePerson. Rewording the text does not create the path it assumes.
  [warning] unreachable-from-action-input — Action "createMaintenanceWorkOrderForMaintenanceProcess" has input class MaintenanceProcess, and its effect refers to MaintenanceWorkOrderRecord, which is not connected to it at all. Add or redirect a relationship so the agent can navigate from MaintenanceProcess to MaintenanceWorkOrderRecord. Rewording the text does not create the path it assumes.
...
#   [warning] unreachable-from-action-input — Action "assignQualifiedMaintenancePersonToMaintenanceActivity" has input class MaintenanceActivity, and its effect refers to QualifiedMaintenancePerson, which is not connected to it at all.
#   [warning] unreachable-from-action-input — Action "classifyItemAsFailed" has input class MaintainableItem, and its effect refers to FailedState, which is not connected to it at all.
#   [warning] unreachable-from-action-input — Action "createMaintenanceWorkOrderForMaintenanceProcess" has input class MaintenanceProcess, and its effect refers to MaintenanceWorkOrderRecord, which is not connected to it at all.
...
#   [warning] unreachable-from-action-input — Action "assignQualifiedMaintenancePersonToMaintenanceActivity" has input class MaintenanceActivity, and its effect refers to QualifiedMaintenancePerson, which is not connected to it at all.
#   [warning] unreachable-from-action-input — Action "classifyItemAsFailed" has input class MaintainableItem, and its effect refers to FailedState, which is not connected to it at all.
#   [warning] unreachable-from-action-input — Action "createMaintenanceWorkOrderForMaintenanceProcess" has input class MaintenanceProcess, and its effect refers to MaintenanceWorkOrderRecord, which is only reachable against the direction of the relationships between them.
...
# CONSISTENCY CHECK — 3 outstanding problem(s) in the whole model:
#   [warning] unreachable-from-action-input — Action "assignQualifiedMaintenancePersonToMaintenanceActivity" has input class MaintenanceActivity, and its effect refers to QualifiedMaintenancePerson, which is only reachable against the direction of the relationships between them.
#   [warning] unreachable-from-action-input — Action "classifyItemAsFailed" has input class MaintainableItem, and its effect refers to FailedState, which is not connected to it at all.
#   [warning] unreachable-from-action-input — Action "createMaintenanceWorkOrderForMaintenanceProcess" has input class MaintenanceProcess, and its effect refers to MaintenanceWorkOrderRecord, which is only reachable against the direction of the relationships between them.
...
```
{
  "yaml": "classes:\n  MaintenanceProcess:\n    meaning: A process carried out to retain or restore the function of a maintainable item under a maintenance strategy.\n  MaintenanceStrategy:\n    meaning: The maintenance approach used to help an asset or item achieve the required objectives.\n  MaintenanceActivity:\n    meaning: A single maintenance task performed to retain or restore the function of a maintainable item.\n  QualifiedMaintenancePerson:\n    meaning: A person who is qualified to perform a specified maintenance activity.\n  QualificationSpecification:\n    meaning: A requirement that says what assessed skill a person must have for a specific task."
}
```
...
```
{
  "yaml": "classes:\n  RequiredFunction:\n    meaning: A function of a maintainable item that is necessary for it to meet the process need it exists to serve.\n  FailureModeCode:\n    meaning: A code used to describe an undesirable disposition or known failure mode.\n  UndesirableDisposition:\n    meaning: A disposition of an item to undergo a process that leads to an undesirable outcome.\n  FailureEffect:\n    meaning: The consequence of a failure event, whether inside the item boundary or beyond it.\n  FunctioningProcess:\n    meaning: The process in which an item is carrying out its function."
}
```
...
```
{
  "yaml": "relationships:\n  - name: initiates\n    from: FailureEvent\n    to: FailedState\n    meaning: The failure event begins the failed state.\n  - name: describes\n    from: MaintenanceWorkOrderRecord\n    to: MaintenanceProcess\n    meaning: The maintenance work order record describes the maintenance process.\n  - name: governedBy\n    from: MaintenanceProcess\n    to: MaintenanceStrategy\n    meaning: The maintenance process is carried out under the maintenance strategy.\n  - name: hasActivity\n    from: MaintenanceProcess\n    to: MaintenanceActivity\n    meaning: The maintenance process includes the maintenance activity as one of its tasks.\n  - name: requiresQualification\n    from: MaintenanceActivity\n    to: QualificationSpecification\n    meaning: The maintenance activity requires that the qualification specification be met."
}
```
...
```
{
  "yaml": "relationships:\n  - name: qualifiedFor\n    from: QualifiedMaintenancePerson\n    to: MaintenanceActivity\n    meaning: The person is qualified to perform the maintenance activity.\n  - name: realizes\n    from: FunctioningProcess\n    to: RequiredFunction\n    meaning: The functioning process is how the required function gets carried out.\n  - name: describes\n    from: FailureModeCode\n    to: UndesirableDisposition\n    meaning: The failure mode code describes the undesirable disposition.\n  - name: hasEffect\n    from: FailureEvent\n    to: FailureEffect\n    meaning: The failure event has the failure effect as a consequence."
}
```
