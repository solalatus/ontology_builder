...
Last updated: 2026-08-21T14:04:48.691Z
...
```
{
  "yaml": "competency_questions:\n  - text: Which air handler serves a given terminal unit or plenum?\n  - text: What spaces are on a given floor?\n  - text: Which floor is a given space on?\n  - text: What HVAC equipment is physically located in this building?\n  - text: What HVAC equipment is physically located on a given floor?\n  - text: What HVAC equipment is physically located in a given room?\n  - text: Which temperature sensors belong to a given air handler?\n  - text: Which setpoints belong to a given air handler?\n  - text: If discharge air temperature is off target, which setpoint should be checked?\n  - text: If air temperature is off target, which setpoint should be checked?\n  - text: Which outside-air CO2 sensors are tied to a given air-handling system?\n  - text: Which return-air CO2 sensors are tied to a given air-handling system?\n  - text: Which occupancy sensor is used for a given space or zone?\n  - text: Which thermostat serves a given zone or space?\n  - text: Which terminal unit serves a given zone or space?\n  - text: What parts does a given air handler have?\n  - text: What equipment is upstream of a given terminal unit or plenum?\n  - text: What heating devices connect back to a given boiler, chiller, or heat-pump path?\n  - text: What cooling devices connect back to a given boiler, chiller, or heat-pump path?\n  - text: Can economizer operation be used for a given air handler under current conditions?\n\nactions:\n  enableEconomizerOperation:\n    input: AirHandler\n    effect: Enable economizer operation on the air handler when conditions support it.\n    verification: Confirm the air handler is operating in economizer mode.\n  increaseCoolingOnAirHandler:\n    input: AirHandler\n    effect: Increase cooling on the air handler when measured air temperature is above the cooling target.\n    verification: Confirm the measured air temperature moves toward the cooling target.\n  increaseHeatingOnAirHandler:\n    input: AirHandler\n    effect: Increase heating on the air handler when measured air temperature is below the heating target.\n    verification: Confirm the measured air temperature moves toward the heating target.\n  verifyOccupiedZoneHasActiveConditioning:\n    input: Zone\n    effect: Verify that an occupied zone has active conditioning available.\n    verification: Confirm whether conditioning is available to the occupied zone.\n  holdAirHandlerSteady:\n    input: AirHandler\n    effect: Hold the air handler steady when temperature is within deadband and no change is needed.\n    verification: Confirm no control change was made and temperature remains within deadband.\n\nclasses:\n  AirHandler: {}\n  Zone: {}"
}
```
...
```
{
  "yaml": "competency_questions:\n  - id: cq6\n    text: What HVAC equipment is physically located in a given space?\n\nclasses:\n  TerminalUnit: {}\n  Plenum: {}\n  Space: {}\n  Floor: {}\n  Building: {}"
}
```
...
```
{
  "yaml": "competency_questions:\n  - id: cq1\n    text: Which air handling unit serves a given terminal unit or plenum?\n  - id: cq7\n    text: Which temperature sensors belong to a given air handling unit?\n  - id: cq8\n    text: Which setpoints belong to a given air handling unit?\n  - id: cq11\n    text: Which outside-air CO2 sensors are tied to a given air-handling unit?\n  - id: cq12\n    text: Which return-air CO2 sensors are tied to a given air-handling unit?\n  - id: cq16\n    text: What parts does a given air handling unit have?\n  - id: cq20\n    text: Can economizer operation be used for a given air handling unit under current conditions?\n\nactions:\n  enableEconomizerOperation:\n    input: AirHandler\n    effect: Enable economizer operation on the air handling unit when conditions support it.\n    verification: Confirm the air handling unit is operating in economizer mode.\n  increaseCoolingOnAirHandler:\n    input: AirHandler\n    effect: Increase cooling on the air handling unit when measured air temperature is above the cooling target.\n    verification: Confirm the measured air temperature moves toward the cooling target.\n  increaseHeatingOnAirHandler:\n    input: AirHandler\n    effect: Increase heating on the air handling unit when measured air temperature is below the heating target.\n    verification: Confirm the measured air temperature moves toward the heating target.\n  holdAirHandlerSteady:\n    input: AirHandler\n    effect: Hold the air handling unit steady when temperature is within deadband and no change is needed.\n    verification: Confirm no control change was made and temperature remains within deadband.\n\nclasses:\n  AirHandler:\n    aliases: [air handling unit, AHU]\n  Boiler: {}\n  Chiller: {}\n  Fan: {}\n  Filter: {}\n  Damper: {}\n  Economizer: {}\n  CoolingValve: {}\n  HeatingValve: {}"
}
```

### Turn 7 — tool

Applied. Added 8, updated 12 existing item(s).

CONSISTENCY CHECK — 1 new problem(s) from this edit:
  [warning] unreachable-from-action-input — Action "enableEconomizerOperation" has input class AirHandler, and its effect refers to Economizer, which is not connected to it at all. Add or redirect a relationship so the agent can navigate from AirHandler to Economizer. Rewording the text does not create the path it assumes.
...
#   [warning] unreachable-from-action-input — Action "enableEconomizerOperation" has input class AirHandler, and its effect refers to Economizer, which is not connected to it at all.
...
```
{
  "yaml": "competency_questions:\n  - id: cq18\n    text: Which heating valves are fed by a given boiler?\n  - id: cq19\n    text: Which cooling valves are fed by a given chiller?"
}
```
...
```
{
  "yaml": "classes:\n  Building:\n    meaning: The overall facility that contains the floors, spaces, zones, and HVAC equipment we are responsible for.\n  Floor:\n    meaning: A building level that groups the spaces on that level.\n  Space:\n    meaning: A physical area like an office, conference room, lobby, or mechanical room where equipment may be located or comfort is managed.\n  Zone:\n    meaning: A control area that is regulated together, sometimes one room and sometimes a group of spaces on the same control point.\n  AirHandler:\n    meaning: The main air-side unit that moves and conditions air for downstream distribution.\n  TerminalUnit:\n    meaning: The local air-side device that serves a space and helps regulate airflow or delivered conditioning to that area.\n  Plenum:\n    meaning: An air-distribution section that receives air for supply, return, or exhaust movement.\n  Thermostat:\n    meaning: The local control device that reads temperature and works to maintain the desired setpoint for a zone.\n  OccupancySensor:\n    meaning: A device that indicates whether a space or zone is occupied for control purposes.\n  Economizer:\n    meaning: The AHU function or device that uses suitable air-side conditions to reduce mechanical heating or cooling."
}
```
...
```
{
  "yaml": "classes:\n  TemperatureSensor:\n    meaning: A sensor that measures temperature for control or monitoring.\n  AirTemperatureSensor:\n    meaning: A temperature sensor specifically measuring air temperature in the air side of the system.\n  Setpoint:\n    meaning: A target value the control system is trying to maintain.\n  AirTemperatureSetpoint:\n    meaning: The target air temperature an air-side control loop is trying to maintain.\n  CoolingTemperatureSetpoint:\n    meaning: The temperature target that tells the system when cooling should satisfy the load.\n  HeatingTemperatureSetpoint:\n    meaning: The temperature target that tells the system when heating should satisfy the load.\n  TemperatureDeadbandSetpoint:\n    meaning: The allowed temperature range between heating and cooling action so the system is not fighting itself.\n  OutsideAirCO2Sensor:\n    meaning: A sensor that measures CO2 in outside air for ventilation or economizer-related comparison.\n  ReturnAirCO2Sensor:\n    meaning: A sensor that measures CO2 in return air so we can compare building air back to outside conditions.\n  Boiler:\n    meaning: The plant equipment that provides hot water for the heating side of the system.\n  Chiller:\n    meaning: The plant equipment that provides chilled water for the cooling side of the system.\n  Fan:\n    meaning: The component that moves air through the unit and distribution path.\n  Filter:\n    meaning: The component that removes particulate from the air stream.\n  Damper:\n    meaning: The air-side component that opens, closes, or modulates to control airflow.\n  CoolingValve:\n    meaning: The valve that controls chilled-water flow through a cooling coil.\n  HeatingValve:\n    meaning: The valve that controls hot-water flow through a heating coil."
}
```
...
```
{
  "yaml": "relationships:\n  - name: hasFloor\n    from: Building\n    to: Floor\n    meaning: A building contains floors as part of its physical layout.\n  - name: hasSpace\n    from: Floor\n    to: Space\n    meaning: A floor contains the spaces located on that level.\n  - name: feeds\n    from: AirHandler\n    to: TerminalUnit\n    meaning: The source equipment is upstream and supplies air or water to the downstream device in the HVAC path.\n  - name: feeds\n    from: AirHandler\n    to: Plenum\n    meaning: The source equipment is upstream and supplies air or water to the downstream device in the HVAC path.\n  - name: serves\n    from: Thermostat\n    to: Zone\n    meaning: The equipment or control device is responsible for meeting the conditioning or control needs of that zone or space.\n  - name: serves\n    from: TerminalUnit\n    to: Space\n    meaning: The equipment or control device is responsible for meeting the conditioning or control needs of that zone or space.\n  - name: locatedIn\n    from: AirHandler\n    to: Building\n    meaning: The equipment or sensor is physically installed within that building or space.\n  - name: locatedOn\n    from: AirHandler\n    to: Floor\n    meaning: The air handling unit is physically installed on that floor.\n  - name: locatedIn\n    from: TerminalUnit\n    to: Space\n    meaning: The equipment or sensor is physically installed within that building or space.\n  - name: locatedIn\n    from: Thermostat\n    to: Space\n    meaning: The equipment or sensor is physically installed within that building or space.\n  - name: locatedIn\n    from: Boiler\n    to: Building\n    meaning: The equipment or sensor is physically installed within that building or space.\n  - name: locatedIn\n    from: Boiler\n    to: Space\n    meaning: The equipment or sensor is physically installed within that building or space.\n  - name: locatedIn\n    from: Chiller\n    to: Building\n    meaning: The equipment or sensor is physically installed within that building or space.\n  - name: locatedIn\n    from: Chiller\n    to: Space\n    meaning: The equipment or sensor is physically installed within that building or space.\n  - name: hasPart\n    from: AirHandler\n    to: Economizer\n    meaning: The larger piece of equipment includes that component as one of its parts.\n  - name: hasPoint\n    from: AirHandler\n    to: TemperatureSensor\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: AirHandler\n    to: AirTemperatureSensor\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: AirHandler\n    to: OutsideAirCO2Sensor\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: AirHandler\n    to: ReturnAirCO2Sensor\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: AirHandler\n    to: Setpoint\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: AirHandler\n    to: AirTemperatureSetpoint\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: AirHandler\n    to: CoolingTemperatureSetpoint\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: AirHandler\n    to: HeatingTemperatureSetpoint\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: AirHandler\n    to: TemperatureDeadbandSetpoint\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPart\n    from: AirHandler\n    to: Fan\n    meaning: The larger piece of equipment includes that component as one of its parts.\n  - name: hasPart\n    from: AirHandler\n    to: Filter\n    meaning: The larger piece of equipment includes that component as one of its parts.\n  - name: hasPart\n    from: AirHandler\n    to: Damper\n    meaning: The larger piece of equipment includes that component as one of its parts.\n  - name: hasPart\n    from: AirHandler\n    to: CoolingValve\n    meaning: The larger piece of equipment includes that component as one of its parts.\n  - name: hasPart\n    from: AirHandler\n    to: HeatingValve\n    meaning: The larger piece of equipment includes that component as one of its parts.\n  - name: hasPoint\n    from: Thermostat\n    to: TemperatureSensor\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: Thermostat\n    to: Setpoint\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: Space\n    to: OccupancySensor\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: hasPoint\n    from: Zone\n    to: OccupancySensor\n    meaning: The equipment, space, zone, or thermostat has that sensor or setpoint associated with it for monitoring or control.\n  - name: feeds\n    from: Boiler\n    to: HeatingValve\n    meaning: The source equipment is upstream and supplies air or water to the downstream device in the HVAC path.\n  - name: feeds\n    from: Chiller\n    to: CoolingValve\n    meaning: The source equipment is upstream and supplies air or water to the downstream device in the HVAC path."
}
```

### Turn 19 — tool

Applied. Added 0, updated 35 existing item(s).
...
```
{
  "yaml": "rules:\n  shouldHoldAirHandlerSteady:\n    conditions:\n      - the relevant active setpoint is the cooling temperature setpoint in a cooling situation or the heating temperature setpoint in a heating situation\n      - the measured air temperature from the air temperature sensor is within the configured temperature deadband around that active setpoint"
}
```
...
```
{
  "yaml": "rules:\n  shouldIncreaseCooling:\n    conditions:\n      - the measured air temperature from the air temperature sensor is above the cooling temperature setpoint"
}
```
...
```
{
  "yaml": "rules:\n  shouldIncreaseHeating:\n    conditions:\n      - the measured air temperature from the air temperature sensor is below the heating temperature setpoint\n  shouldEnableEconomizer:\n    conditions:\n      - the economizer has suitable sensing available\n      - economizer use is intended to reduce mechanical heating or cooling"
}
```
...
```
{
  "yaml": "rules:\n  shouldVerifyOccupiedAreaHasActiveConditioning:\n    conditions:\n      - a zone or space is occupied\n      - a thermostat or terminal unit serves it\n\nactions:\n  holdAirHandlerSteady:\n    preconditions: [shouldHoldAirHandlerSteady]\n  increaseCoolingOnAirHandler:\n    preconditions: [shouldIncreaseCooling]\n  increaseHeatingOnAirHandler:\n    preconditions: [shouldIncreaseHeating]\n  enableEconomizerOperation:\n    preconditions: [shouldEnableEconomizer]\n  verifyOccupiedZoneHasActiveConditioning:\n    preconditions: [shouldVerifyOccupiedAreaHasActiveConditioning]"
}
```
...
#   [warning] unreachable-from-action-input — Action "verifyOccupiedZoneHasActiveConditioning" has input class Zone, and its precondition shouldVerifyOccupiedAreaHasActiveConditioning refers to Space, which is only reachable against the direction of the relationships between them.
#   [warning] unreachable-from-action-input — Action "verifyOccupiedZoneHasActiveConditioning" has input class Zone, and its precondition shouldVerifyOccupiedAreaHasActiveConditioning refers to TerminalUnit, which is only reachable against the direction of the relationships between them.
#   [warning] unreachable-from-action-input — Action "verifyOccupiedZoneHasActiveConditioning" has input class Zone, and its precondition shouldVerifyOccupiedAreaHasActiveConditioning refers to Thermostat, which is only reachable against the direction of the relationships between them.
